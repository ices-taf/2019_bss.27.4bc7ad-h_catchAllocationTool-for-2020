...
#### The seabass catch allocation tool was developed to be used **exclusively** for Sea bass (Dicentrarchus labrax) in divisions 4.b–c, 7.a, and 7.d–h (central and southern North Sea, Irish Sea, English Channel, Bristol Channel, and Celtic Sea) in 2020.  
...
####    1. EU MAP: F<sub>MSY</sub> × SSB<sub>2020</sub> / MSY<sub>Btrigger</sub>
####    1. EU MAP F<sub>MSY</sub> <sub>lower</sub> × SSB<sub>2020</sub> / MSY<sub>Btrigger</sub>
